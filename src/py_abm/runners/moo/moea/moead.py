...
class MOEADRunner(BaseRunner):
    ...
    def __init__(
        ...
        self._prob_neighbor_mating = prob_neighbor_mating
        self._alg = MOEAD(ref_dirs=self._ref_dirs,
                          n_neighbors=self._n_neighbors,
                          prob_neighbor_mating=self._prob_neighbor_mating)
