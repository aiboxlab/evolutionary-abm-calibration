...
baseados no NSGA para otimização do
ABM.
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog="py_abm",
                                     description="ABM calibration with NSGA.")
    ...
    parser.add_argument('--no-adj-rand-score',
                        ...
                        action='store_false')
    parser.add_argument('--unsga3',
                        dest='unsga3',
                        help='Whether to use UNSGA-3 or not.',
                        action='store_true')
    ...
    target = UNSGA3Runner if unsga3 else NSGA2Runner
